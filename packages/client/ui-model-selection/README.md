...
- **Search lives in the composer pane only** — the `/model` popupSelect keeps its full unfiltered option list; filtering inside the shared popup shell would need a command-UI extension point this package does not own.
